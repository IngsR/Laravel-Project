    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Create a new category for your products</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" 
                            ...
                            placeholder="Describe what products belong in this category...">{{ old('description') }}</textarea>
