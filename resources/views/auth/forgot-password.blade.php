<x-guest-layout>
    ...
    <div class="text-center mb-8">
        ...
        <p class="mt-2 text-gray-600 dark:text-gray-400">No worries, we'll send you reset instructions</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
        ...
        <div class="text-center">
            <a href="{{ route('login') }}" class="inline-flex items-center text-sm font-medium text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 transition-colors">
